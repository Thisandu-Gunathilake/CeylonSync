...
export default function Home() {
  return (
    ...
    <main className="relative min-h-screen flex items-center bg-gradient-to-br from-[#1e3a4a] via-[#0f2027] to-[#203a43] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
        {/* LEFT COLUMN */}
        <div className="space-y-6 mt-24 lg:mt-0">
          ...
          <h1 className="text-white text-5xl lg:text-6xl leading-tight font-serif">
